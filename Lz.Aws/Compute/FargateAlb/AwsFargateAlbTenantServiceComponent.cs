...
/// Follows the same patterns as AwsFargateAlbServiceComponent but scoped to a single tenant.
/// </summary>
public class AwsFargateAlbTenantServiceComponent : ComponentResource, ITenantServiceComponent
{
    public AwsFargateAlbTenantServiceComponent()
        ...
        ITenantDataOutputs tenantData)
    {
        ...
        // Bucket is created by AwsFargateAlbTenantDataComponent ({sk}-{tk}-{stk}-media--{suffix}).
        ...
        var taskDef = new TaskDefinition($"{prefix}-{serviceName}-task", new TaskDefinitionArgs
        {
            ...
            ).Apply(async t =>
            {
                ...
                // whose secret predates these keys (AwsFargateAlbTenantDataComponent uses
        ...
        return new AwsFargateAlbTenantServiceOutputs(
    ...
    private static InputList<ServiceLoadBalancerArgs> BuildLoadBalancers(
        ...
        TargetGroup primaryTg, TargetGroup? vpnTg, AwsFargateAlbNetworkOutputs awsNetwork)
    {
...
internal class AwsFargateAlbTenantServiceOutputs : IServiceOutputs
{
    public Output<string> ServiceId { get; }
    public Output<string> Endpoint { get; }

    public AwsFargateAlbTenantServiceOutputs(Output<string> serviceId, Output<string> endpoint)
    {
        ServiceId = serviceId;
        Endpoint = endpoint;
    }
