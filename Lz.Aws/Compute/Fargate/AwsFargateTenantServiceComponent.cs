...
/// </summary>
public class AwsFargateTenantServiceComponent : ComponentResource, ITenantServiceComponent
{
    ...
    public AwsFargateTenantServiceComponent(SystemConfig? systemConfig = null)
    ...
    /// correct when this is the listener's only service (the Fargate topology).
        ...
        ITenantDataOutputs tenantData)
    {
        ...
        var computeOutputs = (AwsFargateComputeOutputs)compute;
            ...
            Policy = Output.Tuple(callerId.Apply(c => c.AccountId), awsRegion.Apply(r => r.Name))
                .Apply(ids => $@"{{
                    ...
                    ""Statement"": [
                        ...
                        {{ ""Effect"": ""Allow"",
                           ""Action"": [""cognito-idp:AdminCreateUser"", ""cognito-idp:AdminDeleteUser"", ""cognito-idp:AdminGetUser"", ""cognito-idp:AdminUpdateUserAttributes"", ""cognito-idp:ListUsers"", ""cognito-idp:AdminDisableUser"", ""cognito-idp:AdminEnableUser"", ""cognito-idp:AdminUserGlobalSignOut""],
        ...
        // lost. Unconditional (not private-flag-gated): every Fargate tenant needs it,
        ...
        // Fargate topology previously omitted this entirely.)
...
internal class AwsFargateTenantServiceOutputs : IServiceOutputs
{
