...
/// that is shared across topologies (Fargate + Lambda). Keeps the gating
...
internal static class BffWiring
{
        ...
        TenantConfig tenantConfig, ComponentResource parent)
    {
        ...
        // provisioned by AwsEcsFargateCognitoDynamodbPostDeployAction.EnsureTenantTablesAsync. Kept
