...
public class AwsEcsExpressNetworkComponent : ComponentResource, ISystemNetworkComponent
{
    ...
    public INetworkOutputs Deploy(SystemConfig config)
    {
        ...
        // the ~10 sibling EcsExpress systems emit a byte-identical plan. Every
        ...
        // endpoints. Ported from Ecs/AwsEcsNetworkComponent.cs, adapted to
        // EcsExpress naming (priv-1/priv-2) with a SINGLE NAT in publicSubnet1.
        ...
        // Ecs/AwsEcsNetworkComponent.cs. Ingress from the VPC CIDR (tailnet peers
