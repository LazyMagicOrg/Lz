...
///
/// <para>1. Everything the Fargate tenant post-deploy does, reused with an
...
public class AwsLambdaPostDeployAction : IPostDeployAction
{
    ...
    private readonly AwsEcsFargateCognitoDynamodbPostDeployAction _inner;
        ...
        string? tenantKey, TenantConfig? tenantConfig)
    {
        ...
        _inner = new AwsEcsFargateCognitoDynamodbPostDeployAction(
    ...
    public async Task ExecuteAsync(IDictionary<string, object> outputs)
    {
        ...
        foreach (var svc in _services)
        {
            ...
            if (result.Outcome == Lz.Aws.Ops.UpdateOutcome.Failed)
