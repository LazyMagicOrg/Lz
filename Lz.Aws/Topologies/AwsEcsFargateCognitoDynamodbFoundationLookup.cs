...
/// </summary>
public static class AwsEcsFargateCognitoDynamodbFoundationLookup
{
        ...
        Lookup(SystemConfig config)
    {
        ...
        var network = new AwsFargateNetworkOutputs
        {
        ...
        var compute = new AwsFargateComputeOutputs
        {
        ...
        var fileStorage = new AwsS3FileStorageOutputs { FileSystemId = Output.Create("") };
